...
# views.LoanedBooksByUserListView.as_view() здесь задействуем шаблон bookinstance_list_borrowed_user.html в самих views
# также прописываем name='' в base_generic.html
urlpatterns += [
