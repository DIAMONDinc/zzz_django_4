...
# SECRET_KEY = '-9d#m4b=r%ftvvq@%f81q&0od_!+m$er!d9m%l@j0+u#zukzi8'
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'h1q5&ojpy$t+9y(6xk%u*+%+#y-&tek^dz1shutscex+1q%)m&')
...
ROOT_URLCONF = 'locallib4.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        # 'DIRS': [os.path.join(BASE_DIR, './templates')], # так было до всего этого с самого начала установки
        'DIRS': ['./templates', ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'locallib4.wsgi.application'
...
# изменить поведение сессий таким образом, чтобы они записывали любое свое изменение в базу данных и отправляли куки,
#  при каждом запросе
